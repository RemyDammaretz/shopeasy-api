...
--
-- Hôte : localhost:3306
-- Généré le : mar. 22 juin 2021 à 17:17
...
(6, 'épicerie salée', 'images_categories/epicerie_salee.png'),
...
CREATE TABLE `shops` (
  `id` int NOT NULL,
  `name` varchar(255) NOT NULL,
  `urlMap` varchar(255) CHARACTER SET utf8mb4 NOT NULL,
...
CREATE TABLE `users` (
  ...
  `minNutriScorePreference` varchar(1) CHARACTER SET utf8mb4 NOT NULL DEFAULT 'e',
  `allergens` varchar(255) CHARACTER SET utf8mb4 NOT NULL DEFAULT ''
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `users` (`id`, `pseudo`, `pass`, `hash`, `minNutriScorePreference`, `allergens`) VALUES
(1, 'admin', 'admin', '63ca64fbc287072b8a47d94ba49f9a09', 'c', 'Gluten, Lait');
